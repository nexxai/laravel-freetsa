...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-freetsa.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-freetsa)
...
```bash
php artisan vendor:publish --tag="laravel-freetsa-views"
```

## Usage

```php
$freeTsa = new Nexxai\FreeTsa();
echo $freeTsa->echoPhrase('Hello, Nexxai!');
```
